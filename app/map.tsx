...
const styles = StyleSheet.create({
  ...
  map: { flex: 1, position: 'relative', marginTop: 8, minHeight: 380, borderRadius: 22, overflow: 'hidden', borderWidth: 1, borderColor: 'rgba(241,181,42,.45)' }, constellation: { ...StyleSheet.absoluteFillObject, width: '100%', height: '100%', opacity: .76 }, imageShade: { ...StyleSheet.absoluteFillObject, backgroundColor: 'rgba(3,26,45,.32)' },
